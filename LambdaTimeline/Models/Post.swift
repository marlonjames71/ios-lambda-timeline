...
class Post {
    ...
    init(title: String, audioURL: URL, mediaURL: URL, ratio: CGFloat? = nil, author: Author, timestamp: Date = Date()) {
        self.mediaURL = mediaURL
        self.ratio = ratio
        self.mediaType = .image
        self.author = author
        self.comments = [Comment(text: title, audioURL: audioURL, author: author)]
        self.timestamp = timestamp

        #warning("Ask about this tomorrow")
    }
